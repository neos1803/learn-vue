    ...
    <div>
        <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6">
            ...
            <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                ...
                <!-- Search Bar -->
                <div>
                    <input class="bg-white focus:outline-none focus:shadow-outline border border-gray-300 rounded-lg py-2 px-4 block w-full appearance-none leading-normal" type="text" placeholder="Insert Title">
                </div>
            </div>
        </nav>
    </div>
